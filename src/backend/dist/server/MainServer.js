        ...
        return new Promise((resolve, reject) => {
            ...
            this.mainWindow.tool_call.callReAct(_data)
                ...
                let message_list = chatManager.getMessages(true)
                    .filter((message) => message.group_id === result.group_id);
                message_list = this.mainWindow.llm_service.adapter.formatMessages(message_list, result.params, result.env_message);
    ...
    async checkout(data) {
        try {
            ...
            if (data?.chat_id) {
                ...
                this.mainWindow.window?.webContents.send('new-chat', chatManager.chat);
                this.mainWindow.tool_call.setHistory();
            }
