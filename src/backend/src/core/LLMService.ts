...
export class LLMService {
    ...
    private async handleStream(resp: Response, adapter: any, headers: any, body: any, data: ChatRequestData, messageOutput: AssistantMessage): Promise<boolean> {
        ...
        for await (chunk of streamRes) {
            ...
            if (thinking_signature) {
                (messageOutput as any).thinking_signature = thinking_signature;
            }
    ...
    private async handleNormal(resp: Response, adapter: ILLMAdapter, headers: any, body: any, data: ChatRequestData, messageOutput: AssistantMessage): Promise<boolean> {
        ...
        if (thinking_signature) (messageOutput as any).thinking_signature = thinking_signature;
        if (tool_calls) {
