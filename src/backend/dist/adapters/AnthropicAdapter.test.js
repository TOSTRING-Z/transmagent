...
describe('AnthropicAdapter Unit Tests', () => {
    let adapter;
    beforeEach(() => {
        adapter = new AnthropicAdapter_1.AnthropicAdapter();
    ...
    describe('buildPayload', () => {
        it('应该正确提取并剥离最后的 【system】 标记到顶层 system 字段', () => {
            ...
            const data = { version: 'claude-3', llm_params: {} };
    ...
    describe('truncatedResponse (Async Continuation)', () => {
        it('应当就地修改 array 并移除 tools 以补全 JSON', async () => {
            ...
            const mockData = { api_url: 'https://api.anthropic.com', output: '' };
...
//# sourceMappingURL=AnthropicAdapter.test.js.map