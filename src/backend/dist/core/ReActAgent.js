...
class ReActAgent {
    ...
    getDataDefault(cdata = {}) {
        ...
        let defaults = {
            ...
            params: null,
            llm_params: globals_1.utils.getConfig('tool_call')["llm_params"],
            memory_length: globals_1.utils.getConfig('tool_call')["memory_length"],
            long_memory_length: globals_1.utils.getConfig('tool_call')["long_memory_length"],
            max_tokens: globals_1.utils.getConfig('tool_call')["max_tokens"],
            push_message: true,
            end: null,
