...
class CodeWindow extends BaseWindow_1.BaseWindow {
    constructor(windowManager) {
        super(windowManager);
        this.llmService_completion = null;
        this.react_agent_completion = null;
        this.llmService_refactor = null;
        this.react_agent_refactor = null;
        this.auto_complete_enabled = false; // 自动AI补全开关，默认关闭
        this.auto_error_correct_enabled = false; // 自动错误纠正开关，默认关闭
    }
    create() {
        if (this.window) {
            this.window.restore();
