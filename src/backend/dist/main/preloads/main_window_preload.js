...
electron_1.contextBridge.exposeInMainWorld('electronAPI', {
    ...
    setGlobal: (chat) => electron_1.ipcRenderer.send('set-global', chat),
    ...
    handleOptions: (callback) => electron_1.ipcRenderer.on('options', (_event, data) => callback(data)),
    ...
    handleNewChat: (callback) => electron_1.ipcRenderer.on('new-chat', (_event, chat) => callback(chat)),
    handleSelectChat: (callback) => electron_1.ipcRenderer.on('select-chat', (_event, chat) => callback(chat)),
    handleSetChat: (callback) => electron_1.ipcRenderer.on('handleSetChat', (_event, chat) => callback(chat)),
    handleAutoRenameChat: (callback) => electron_1.ipcRenderer.on('auto-rename-chat', (_event, chat) => callback(chat)),
    ...
    newChat: () => electron_1.ipcRenderer.invoke('new-chat'),
