...
import { PendingMessage } from './BackgroundTaskRegistry';
/**
 * 贯穿整条管道的上下文对象。
 ...
 */
export declare function createBackgroundMessageMiddleware(getSessionId: () => string, injectMessage: (msg: PendingMessage) => void): any;
