...
const prompt = {
    ...
    agent_description: `I am tool_manager, specializing in managing the construction, installation, configuration, maintenance, and updating of reusable system tools.
...
* **Root Directory**: \`/data/auto_installed_tools/<Tool_Name>/\`
    ...
    * 📂 \`example/\`: Stores example files`,
    ...
    agent_prompt: `I am tool_manager, specializing in managing the construction, installation, configuration, maintenance, and updating of reusable system tools.
