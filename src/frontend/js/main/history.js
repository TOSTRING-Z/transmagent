...
export async function handleloadChat(chat) {
    updateChat(chat);
...
export function setHistoryRunning(chatId) {
...
export function setHistoryCompleted(chatId) {
    const item = document.getElementById(chatId);
    if (item) {
...
export function filterHistory(mode) {
    historyFilter = mode;
...
export async function toggleStar(chatId) {
