...
const SkillManager_1 = require("../core/SkillManager"); // 确保路径正确
function getPrompt() {
    return {
...
function main() {
    return async (params) => {
        ...
        const prompt_file = globals_1.utils.getConfig("tool_call")?.cli_prompt || globals_1.utils.getDefault("prompts/cli_prompt.md");
